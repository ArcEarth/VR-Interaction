...
Metaball::Metaball(const DirectX::XMFLOAT3 &_Position,float _Radius,unsigned int _BindingIndex)
...
Metaball::Metaball( const DirectX::XMFLOAT4 & Sphere,unsigned int _BindingIndex /*= 0*/ )
