...
namespace Geometrics
{
	...
	size_t RayIntersection(const PolygonSoup<_VertexType,_IndexType,Triangle<_IndexType>> &Mesh , DirectX::FXMVECTOR Origin , DirectX::FXMVECTOR Direction , std::vector<DirectX::XMFLOAT3>* output = nullptr)
	{
		size_t count = 0;
	...
	template <typename _VertexType , typename _IndexType>
	inline float Distance(const PolygonSoup<_VertexType,_IndexType,Triangle<_IndexType>> &Mesh , DirectX::FXMVECTOR Point)
	{
		using namespace DirectX;
	...
	template <typename _VertexType , typename _IndexType>
	bool Inside(const PolygonSoup<_VertexType,_IndexType,Triangle<_IndexType>> &Mesh,DirectX::FXMVECTOR Point)
	{
		XMFLOAT3A Direction;
