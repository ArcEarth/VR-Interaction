...
RenderTargetTexture2D::RenderTargetTexture2D( ID3D11Resource* pResource , ID3D11RenderTargetView* pRenderTargetView , ID3D11ShaderResourceView* pShaderResouceView)
	: Texture2D(pResource,pShaderResouceView)
{
	assert (pRenderTargetView);
	m_pRenderTargetView = pRenderTargetView;
}
