...
namespace Geometrics
{
	...
	Model csgjs_union(const Model & a, const Model & b);
	Model csgjs_intersection(const Model & a, const Model & b);
	Model csgjs_difference(const Model & a, const Model & b);
...
// point is on the plane.
	...
	inline static Vector3 operator + (const Vector3 & a, const Vector3 & b) { return Vector3(a.x + b.x, a.y + b.y, a.z + b.z); }
	inline static Vector3 operator - (const Vector3 & a, const Vector3 & b) { return Vector3(a.x - b.x, a.y - b.y, a.z - b.z); }
	inline static Vector3 operator * (const Vector3 & a, float b) { return Vector3(a.x * b, a.y * b, a.z * b); }
	inline static Vector3 operator / (const Vector3 & a, float b) { return a * (1.0f / b); }
	...
	ConvexPolygon::ConvexPolygon(const std::vector<Vertex> & list) : vertices(list), plane(vertices[0].pos, vertices[1].pos, vertices[2].pos)
	{
	}
	...
	inline static std::vector<ConvexPolygon> ModelToPolygons(const Model & model)
	{
	...
	inline static Model ModelFromPolygons(const std::vector<ConvexPolygon> & polygons)
	{
		Model model;
		int p = 0;
	...
	inline static Model nodeOperation(const Model & a, const Model & b, nodeFunction fun)
	{
